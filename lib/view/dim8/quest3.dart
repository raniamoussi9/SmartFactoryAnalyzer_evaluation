...
import 'package:smart_factory_analyzer/view/dim8/quest4.dart';

import '../welcome_page.dart';

class Quest3dim8 extends StatelessWidget {
  const Quest3dim8({super.key});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => Quest4dim8()),
          );
        },
