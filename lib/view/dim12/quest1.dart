...
import 'package:smart_factory_analyzer/view/dim12/quest2.dart';
import 'package:smart_factory_analyzer/view/dim2/quest2.dart';

import '../welcome_page.dart';

class Quest1dim12 extends StatelessWidget {
  const Quest1dim12({super.key});
    ...
    return SafeArea(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Quest2dim12()),
          );
        },
