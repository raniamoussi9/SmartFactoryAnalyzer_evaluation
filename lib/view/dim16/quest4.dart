...
import 'package:smart_factory_analyzer/view/dim16/quest5.dart';
import 'package:smart_factory_analyzer/view/dim2/quest5.dart';

import '../welcome_page.dart';

class Quest4dim16 extends StatelessWidget {
  const Quest4dim16({super.key});
    ...
    return SafeArea(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Quest5dim16()),
          );
        },
