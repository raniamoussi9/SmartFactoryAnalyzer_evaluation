...
import 'package:smart_factory_analyzer/view/dim16/quest6.dart';
import 'package:smart_factory_analyzer/view/dim2/quest6.dart';

import '../welcome_page.dart';

class Quest5dim16 extends StatelessWidget {
  const Quest5dim16({super.key});
    ...
    return SafeArea(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Quest6dim16()),
          );
        },
