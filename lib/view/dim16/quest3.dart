...
import 'package:smart_factory_analyzer/view/dim16/quest4.dart';
import 'package:smart_factory_analyzer/view/dim2/quest4.dart';

import '../welcome_page.dart';

class Quest3dim16 extends StatelessWidget {
  const Quest3dim16({super.key});
    ...
    return SafeArea(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Quest4dim16()),
          );
        },
