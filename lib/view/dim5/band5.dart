...
class Band5 extends StatefulWidget {
  @override
  _Band5State createState() => _Band5State();
}

class _Band5State extends State<Band5> {
      ...
      child: Scaffold(
          ...
          title: Row(
            ...
            children: [
              Text.rich(TextSpan(children: [
                ...
                TextSpan(
                    text: 'Technology – Automation – Entreprise Automation',
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => Band6()),
            );
          },
