...
class CompanyDetailsPageInput2 extends StatefulWidget {
  const CompanyDetailsPageInput2({super.key});

  @override
  State<CompanyDetailsPageInput2> createState() => _CompanyDetailsPageInput2State();
}

class _CompanyDetailsPageInput2State extends State<CompanyDetailsPageInput2> {
