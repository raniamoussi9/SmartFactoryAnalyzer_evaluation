...
class Band10 extends StatefulWidget {
  @override
  _Band10State createState() => _Band10State();
}

class _Band10State extends State<Band10> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            'Shop Floor Intelligence is the processing and analysis of data to optimize existing processes and create new applications, products and services within the location where the production and management of goods are carried out.',
            textAlign: TextAlign.center,
      ...
      child: Scaffold(
          ...
          title: Row(
            ...
            children: [
              Text.rich(TextSpan(children: [
                ...
                TextSpan(
                    text: 'Technology – Intelligence – Shop Floor Intelligence',
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => Quest1dim10()),
            );
          },
