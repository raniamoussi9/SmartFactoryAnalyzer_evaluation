...
import 'package:smart_factory_analyzer/view/dim8/band8.dart';
...
class Band7 extends StatefulWidget {
  @override
  _Band7State createState() => _Band7State();
}

class _Band7State extends State<Band7> {
  ...
  List<String> definitions = [
    ...
    "Interoperable production assets and systems are secure; There is a vigilant and resilient security framework to protect the network of interoperable equipment, machinery and computer-based systems from undesired access and/or disruption.",
    "Interoperable production assets and systems are secure and capable of real-time communication; Interoperable and secure network links across different equipment, machinery and computer-based systems are able to interact or exchange information as the information is generated without delay.",
    "Interoperable production assets and systems are secure, capable of real-time communication, and scalable; Existing networks can be configured quickly and easily to accommodate any modifications made to the existing composition of equipment, machinery and computer-based systems."
  ];
      ...
      child: Scaffold(
          ...
          title: Row(
            ...
            children: [
              Text.rich(TextSpan(children: [
                ...
                TextSpan(
                    text: 'Technology – Connectivity – Shop Floor Connectivity',
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => Band8()),
            );
          },
