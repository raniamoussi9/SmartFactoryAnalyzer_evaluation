...
import 'package:smart_factory_analyzer/view/dim9/quest5.dart';

import '../welcome_page.dart';

class Quest4dim9 extends StatelessWidget {
  const Quest4dim9({super.key});
    ...
    return SafeArea(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Quest5dim9()),
          );
        },
