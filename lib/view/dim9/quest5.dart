...
import 'package:smart_factory_analyzer/view/dim9/quest6.dart';

import '../welcome_page.dart';

class Quest5dim9 extends StatelessWidget {
  const Quest5dim9({super.key});
    ...
    return SafeArea(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Quest6dim9()),
          );
        },
