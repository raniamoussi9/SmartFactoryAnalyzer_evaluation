...
import 'package:smart_factory_analyzer/view/dim9/quest3.dart';

import '../welcome_page.dart';

class Quest2dim9 extends StatelessWidget {
  const Quest2dim9({super.key});
    ...
    return SafeArea(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Quest3dim9()),
          );
        },
