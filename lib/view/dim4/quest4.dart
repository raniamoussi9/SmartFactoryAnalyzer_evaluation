...
import 'package:smart_factory_analyzer/view/dim4/quest5.dart';

import '../welcome_page.dart';

class Quest4dim4 extends StatelessWidget {
  const Quest4dim4({super.key});
    ...
    return SafeArea(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Quest5dim4()),
          );
        },
