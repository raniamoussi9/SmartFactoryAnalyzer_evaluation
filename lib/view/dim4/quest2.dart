...
import 'package:smart_factory_analyzer/view/dim4/quest3.dart';

import '../welcome_page.dart';

class Quest2dim4 extends StatelessWidget {
  const Quest2dim4({super.key});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => Quest3dim4()),
          );
        },
